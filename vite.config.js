...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      // в three@0.149 его нет. Используем наш патч совместимости.
      'three/examples/jsm/utils/BufferGeometryUtils': fileURLToPath(new URL('./src/compat/three-compat-patch.js', import.meta.url)),
    },
  },
  optimizeDeps: {
